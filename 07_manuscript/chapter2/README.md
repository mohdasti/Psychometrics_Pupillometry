...
- **`data/processed/ch2_triallevel_merged.csv`**: Pre-merged trial-level data containing both behavioral and pupil measures (copied from `modeling-pupil-DDM/quick_share_v7/analysis_ready/ch2_triallevel.csv`)

### Behavioral Data (Backup)

- **`data/raw/behavioral/bap_beh_trialdata_v2.csv`**: Raw trial-level behavioral data
- **`data/raw/behavioral/bap_beh_subjxtaskdata_v2.csv`**: Subject-level summaries by task
